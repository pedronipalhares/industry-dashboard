...
tab1, tab2 = st.tabs(["Price Trends", "Data Tables"])

# Tab 1: Price Trends (Graphs)
with tab1:
...
with tab2:
    ...
    with col1:
        st.write("#### Beef Prices")
        st.dataframe(beef_df, use_container_width=True)
    
    with col2:
        st.write("#### Cattle Prices")
